package com.example.commenter.config.liquibase;
...
import static com.example.commenter.config.Constants.SPRING_PROFILE_DEVELOPMENT;
import static com.example.commenter.config.Constants.SPRING_PROFILE_NO_LIQUIBASE;
