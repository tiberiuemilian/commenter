...
--
-- Host: localhost    Database: commenter
-- ------------------------------------------------------
...
--
-- Current Database: `commenter`
--

CREATE DATABASE /*!32312 IF NOT EXISTS*/ `commenter` /*!40100 DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci */ /*!80016 DEFAULT ENCRYPTION='N' */;
...
CREATE TABLE `tag` (
  ...
  PRIMARY KEY (`id`),
  KEY `comment_fk_idx` (`comment_id`) /*!80000 INVISIBLE */,
  KEY `author_idx` (`name`),
...
-- Dump completed on 2022-01-06 16:55:15
